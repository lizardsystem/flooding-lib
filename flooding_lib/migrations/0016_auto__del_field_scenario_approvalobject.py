...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scenario.approvalobject'
        db.delete_column('flooding_scenario', 'approvalobject_id')


    def backwards(self, orm):
        
        # Adding field 'Scenario.approvalobject'
        db.add_column('flooding_scenario', 'approvalobject', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['approvaltool.ApprovalObject'], null=True, blank=True), keep_default=False)
