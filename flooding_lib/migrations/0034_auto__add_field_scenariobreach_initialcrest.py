...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScenarioBreach.initialcrest'
        db.add_column('flooding_scenariobreach', 'initialcrest', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScenarioBreach.initialcrest'
        db.delete_column('flooding_scenariobreach', 'initialcrest')
