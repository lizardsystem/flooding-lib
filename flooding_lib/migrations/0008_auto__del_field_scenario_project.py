...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('flooding_scenario', 'project_id')


    def backwards(self, orm):
        
        # Adding field 'Scenario.project'
        db.add_column('flooding_scenario', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flooding_lib.Project'], null=True, blank=True), keep_default=False)
