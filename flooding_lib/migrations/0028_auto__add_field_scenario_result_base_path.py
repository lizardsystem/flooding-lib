...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.result_base_path'
        db.add_column('flooding_scenario', 'result_base_path', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.result_base_path'
        db.delete_column('flooding_scenario', 'result_base_path')
