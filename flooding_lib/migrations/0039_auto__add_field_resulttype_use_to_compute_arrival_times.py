...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResultType.use_to_compute_arrival_times'
        db.add_column('flooding_resulttype', 'use_to_compute_arrival_times', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResultType.use_to_compute_arrival_times'
        db.delete_column('flooding_resulttype', 'use_to_compute_arrival_times')
