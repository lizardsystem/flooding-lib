...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Take only the main ones and set them in the project_id field."""

        for scenarioproject in orm.ScenarioProject.objects.filter(
            is_main_project=True):
            scenario = scenarioproject.scenario
            scenario.project_id = scenarioproject.project_id
            scenario.save()

    def backwards(self, orm):
        """Not needed because project_id is an extra field anyway."""
        pass
