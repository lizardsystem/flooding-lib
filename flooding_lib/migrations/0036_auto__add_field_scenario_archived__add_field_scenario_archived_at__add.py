...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.archived'
        db.add_column('flooding_scenario', 'archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Scenario.archived_at'
        db.add_column('flooding_scenario', 'archived_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.archived_by'
        db.add_column('flooding_scenario', 'archived_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='archived_by_user', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.archived'
        db.delete_column('flooding_scenario', 'archived')

        # Deleting field 'Scenario.archived_at'
        db.delete_column('flooding_scenario', 'archived_at')

        # Deleting field 'Scenario.archived_by'
        db.delete_column('flooding_scenario', 'archived_by_id')
    ...
    models = {
        ...
        'flooding_lib.scenario': {
            ...
            'archived_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'archived_by_user'", 'null': 'True', 'to': "orm['auth.User']"}),
