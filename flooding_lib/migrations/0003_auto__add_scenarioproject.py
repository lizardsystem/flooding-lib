...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScenarioProject'
        db.create_table('flooding_lib_scenarioproject', (
            ...
            ('is_main_project', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('flooding_lib', ['ScenarioProject'])


    def backwards(self, orm):
        
        # Deleting model 'ScenarioProject'
        db.delete_table('flooding_lib_scenarioproject')
