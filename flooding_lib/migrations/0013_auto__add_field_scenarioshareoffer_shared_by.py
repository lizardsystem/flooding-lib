...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScenarioShareOffer.shared_by'
        db.add_column('flooding_lib_scenarioshareoffer', 'shared_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScenarioShareOffer.shared_by'
        db.delete_column('flooding_lib_scenarioshareoffer', 'shared_by_id')
