...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ThreediModel'
        db.create_table('flooding_lib_threedimodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('scenario_zip_filename', self.gf('django.db.models.fields.TextField')()),
            ('mdu_filename', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('flooding_lib', ['ThreediModel'])

        # Adding model 'ThreediCalculation'
        db.create_table('flooding_lib_threedicalculation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('threedi_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flooding_lib.ThreediModel'])),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flooding_lib.Scenario'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('flooding_lib', ['ThreediCalculation'])


    def backwards(self, orm):
        
        # Deleting model 'ThreediModel'
        db.delete_table('flooding_lib_threedimodel')

        # Deleting model 'ThreediCalculation'
        db.delete_table('flooding_lib_threedicalculation')
