...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flooding_lib_scenarioshareoffer', (
            ...
            ('new_project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flooding_lib.Project'])),
        ))
        db.send_create_signal('flooding_lib', ['ScenarioShareOffer'])

        # Adding unique constraint on 'ScenarioShareOffer', fields ['scenario', 'new_project']
        db.create_unique('flooding_lib_scenarioshareoffer', ['scenario_id', 'new_project_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScenarioShareOffer', fields ['scenario', 'new_project']
        db.delete_unique('flooding_lib_scenarioshareoffer', ['scenario_id', 'new_project_id'])
