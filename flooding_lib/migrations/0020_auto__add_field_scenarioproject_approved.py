...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScenarioProject.approved'
        db.add_column('flooding_lib_scenarioproject', 'approved', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScenarioProject.approved'
        db.delete_column('flooding_lib_scenarioproject', 'approved')
