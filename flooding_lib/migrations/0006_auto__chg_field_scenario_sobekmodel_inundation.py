...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.sobekmodel_inundation'
        db.alter_column('flooding_scenario', 'sobekmodel_inundation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flooding_lib.SobekModel'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Scenario.sobekmodel_inundation'
        raise RuntimeError("Cannot reverse this migration. 'Scenario.sobekmodel_inundation' and its values cannot be restored.")
