...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.color_mapping_name'
        db.add_column('flooding_project', 'color_mapping_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.color_mapping_name'
        db.delete_column('flooding_project', 'color_mapping_name')
