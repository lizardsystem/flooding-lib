...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.animation'
        db.add_column('flooding_result', 'animation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyramids.Animation'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Result.animation'
        db.delete_column('flooding_result', 'animation_id')
