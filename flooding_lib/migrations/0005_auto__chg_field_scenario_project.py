...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.project'
        db.alter_column('flooding_scenario', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flooding_lib.Project'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Scenario.project'
        raise RuntimeError("Cannot reverse this migration. 'Scenario.project' and its values cannot be restored.")
