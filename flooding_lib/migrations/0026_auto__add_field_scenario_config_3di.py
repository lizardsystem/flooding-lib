...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.config_3di'
        db.add_column('flooding_scenario', 'config_3di', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.config_3di'
        db.delete_column('flooding_scenario', 'config_3di')
