...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Change program due error in sobek task (130). The results are not
        of the sobek program."""
        program = orm.Program.objects.get(name='calc_statistic')
        type_1 = orm.ResultType.objects.get(name='Total inundated area')
        type_1.program = program
        type_1.save()

        type_2 = orm.ResultType.objects.get(name='Total inundation volume')
        type_2.program = program
        type_2.save()
