...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectColormap'
        db.create_table('flooding_lib_projectcolormap', (
            ...
            ('colormap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyramids.Colormap'])),
        ))
        db.send_create_signal('flooding_lib', ['ProjectColormap'])


    def backwards(self, orm):
        
        # Deleting model 'ProjectColormap'
        db.delete_table('flooding_lib_projectcolormap')
    ...
    models = {
        ...
        'flooding_lib.projectcolormap': {
            'Meta': {'object_name': 'ProjectColormap'},
            'colormap': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pyramids.Colormap']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'flooding_lib.result': {
            ...
            'animation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pyramids.Animation']", 'null': 'True', 'blank': 'True'}),
            ...
            'raster': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pyramids.Raster']", 'null': 'True', 'blank': 'True'}),
