...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Result.animation'
        db.alter_column('flooding_result', 'animation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyramids.Animation'], null=True, on_delete=models.SET_NULL))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Result.raster'
        db.alter_column('flooding_result', 'raster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyramids.Raster'], null=True))

        # Changing field 'Result.animation'
        db.alter_column('flooding_result', 'animation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyramids.Animation'], null=True))
