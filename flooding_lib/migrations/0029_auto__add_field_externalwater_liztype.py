...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExternalWater.liztype'
        db.add_column('flooding_externalwater', 'liztype', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExternalWater.liztype'
        db.delete_column('flooding_externalwater', 'liztype')
