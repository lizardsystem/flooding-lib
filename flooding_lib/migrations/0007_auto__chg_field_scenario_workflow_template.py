...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.workflow_template'
        db.alter_column('flooding_scenario', 'workflow_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flooding_worker.WorkflowTemplate'], null=True, db_column='workflow_template'))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Scenario.workflow_template'
        raise RuntimeError("Cannot reverse this migration. 'Scenario.workflow_template' and its values cannot be restored.")
    ...
    models = {
        ...
        'flooding_lib.scenario': {
            ...
            'x_projects': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'x_scenarios'", 'symmetrical': 'False', 'through': "orm['flooding_lib.ScenarioProject']", 'to': "orm['flooding_lib.Project']"})
        },
