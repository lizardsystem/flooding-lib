...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('flooding_scenario', 'workflow_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_worker.WorkflowTemplate'], null=True, db_column='workflow_template'))
