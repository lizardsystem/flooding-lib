...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScenarioShareOffer'
        db.create_table('flooding_lib_scenarioshareoffer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='original_share', to=orm['flooding_lib.Project'])),
            ('new_project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_share', to=orm['flooding_lib.Project'])),
        ))
        db.send_create_signal('flooding_lib', ['ScenarioShareOffer'])

        # Adding unique constraint on 'ScenarioShareOffer', fields ['original_project', 'new_project']
        db.create_unique('flooding_lib_scenarioshareoffer', ['original_project_id', 'new_project_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScenarioShareOffer', fields ['original_project', 'new_project']
        db.delete_unique('flooding_lib_scenarioshareoffer', ['original_project_id', 'new_project_id'])

        # Deleting model 'ScenarioShareOffer'
        db.delete_table('flooding_lib_scenarioshareoffer')
    ...
    models = {
        ...
        'flooding_lib.scenarioshareoffer': {
            'Meta': {'unique_together': "(('original_project', 'new_project'),)", 'object_name': 'ScenarioShareOffer'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'new_share'", 'to': "orm['flooding_lib.Project']"}),
            'original_project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'original_share'", 'to': "orm['flooding_lib.Project']"})
        },
