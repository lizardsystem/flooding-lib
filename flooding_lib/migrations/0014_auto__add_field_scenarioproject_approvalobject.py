...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScenarioProject.approvalobject'
        db.add_column('flooding_lib_scenarioproject', 'approvalobject', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['approvaltool.ApprovalObject'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScenarioProject.approvalobject'
        db.delete_column('flooding_lib_scenarioproject', 'approvalobject_id')
