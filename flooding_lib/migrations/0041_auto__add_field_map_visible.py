...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Map.visible'
        db.add_column('flooding_map', 'visible', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Map.visible'
        db.delete_column('flooding_map', 'visible')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 8, 14, 34, 42, 996095)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 8, 14, 34, 42, 995752)'}),
        ...
        u'flooding_lib.result': {
            ...
            'animation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pyramids.Animation']", 'null': 'True', 'blank': 'True'}),
            ...
            'raster': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pyramids.Raster']", 'null': 'True', 'blank': 'True'}),
