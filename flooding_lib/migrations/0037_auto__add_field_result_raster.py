...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.raster'
        db.add_column('flooding_result', 'raster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyramids.Raster'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Result.raster'
        db.delete_column('flooding_result', 'raster_id')
