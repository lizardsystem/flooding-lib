...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SobekModel.keep_initial_level'
        db.add_column('flooding_sobekmodel', 'keep_initial_level', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SobekModel.keep_initial_level'
        db.delete_column('flooding_sobekmodel', 'keep_initial_level')
