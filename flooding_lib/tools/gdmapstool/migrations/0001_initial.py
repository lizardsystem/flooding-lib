...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GDMapProject'
        db.create_table(u'gdmapstool_gdmapproject', (
        ...
        db.send_create_signal(u'gdmapstool', ['GDMapProject'])

        # Adding model 'GDMap'
        db.create_table(u'gdmapstool_gdmap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('gd_map_project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gdmapstool.GDMapProject'])),
        ))
        db.send_create_signal(u'gdmapstool', ['GDMap'])

        # Adding M2M table for field scenario on 'GDMap'
        db.create_table(u'gdmapstool_gdmap_scenario', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gdmap', models.ForeignKey(orm[u'gdmapstool.gdmap'], null=False)),
            ('scenario', models.ForeignKey(orm[u'flooding_lib.scenario'], null=False))
        ))
        db.create_unique(u'gdmapstool_gdmap_scenario', ['gdmap_id', 'scenario_id'])


    def backwards(self, orm):
        
        # Deleting model 'GDMapProject'
        db.delete_table(u'gdmapstool_gdmapproject')

        # Deleting model 'GDMap'
        db.delete_table(u'gdmapstool_gdmap')

        # Removing M2M table for field scenario on 'GDMap'
        db.delete_table('gdmapstool_gdmap_scenario')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 8, 14, 57, 24, 723193)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 8, 14, 57, 24, 722904)'}),
        ...
        u'gdmapstool.gdmap': {
            'Meta': {'ordering': "['name']", 'object_name': 'GDMap'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'gd_map_project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gdmapstool.GDMapProject']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'scenario': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['flooding_lib.Scenario']", 'null': 'True', 'blank': 'True'})
        },
        u'gdmapstool.gdmapproject': {
            'Meta': {'ordering': "['creation_date']", 'object_name': 'GDMapProject'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
