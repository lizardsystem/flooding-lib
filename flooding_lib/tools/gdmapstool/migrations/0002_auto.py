...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field scenarios on 'GDMap'
        db.create_table(u'gdmapstool_gdmap_scenarios', (
        ...
        db.create_unique(u'gdmapstool_gdmap_scenarios', ['gdmap_id', 'scenario_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field scenarios on 'GDMap'
        db.delete_table('gdmapstool_gdmap_scenarios')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 9, 11, 23, 33, 327826)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 9, 11, 23, 33, 327536)'}),
        ...
        u'gdmapstool.gdmap': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'scenarios': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['flooding_lib.Scenario']", 'null': 'True', 'blank': 'True'})
        },
