...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RORKering'
        db.create_table('importtool_rorkering', (
        ...
        db.send_create_signal('importtool', ['RORKering'])


    def backwards(self, orm):
        
        # Deleting model 'RORKering'
        db.delete_table('importtool_rorkering')
