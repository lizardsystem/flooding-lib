...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RORKering.description'
        db.add_column('importtool_rorkering', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RORKering.description'
        db.delete_column('importtool_rorkering', 'description')
    ...
    models = {
        ...
        'importtool.rorkering': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': "u'not applied'", 'max_length': '20'}),
