...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.file_basename'
        db.add_column('exporttool_result', 'file_basename', self.gf('django.db.models.fields.CharField')(default='fill me in or rerun', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Result.file_location_windows'
        db.add_column('exporttool_result', 'file_location_windows', self.gf('django.db.models.fields.TextField')(default='asdf'), keep_default=False)

        # Adding field 'Result.file_location_linux'
        db.add_column('exporttool_result', 'file_location_linux', self.gf('django.db.models.fields.TextField')(default='asdf'), keep_default=False)

        # Deleting field 'Result.file_basename'
        db.delete_column('exporttool_result', 'file_basename')
    ...
    models = {
        ...
        'exporttool.result': {
            ...
            'file_basename': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'exporttool.setting': {
