...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExportRun.export_everything_as_zip'
        db.add_column(u'exporttool_exportrun', 'export_everything_as_zip', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExportRun.export_everything_as_zip'
        db.delete_column(u'exporttool_exportrun', 'export_everything_as_zip')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 12, 11, 40, 68952)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 12, 11, 40, 68284)'}),
        ...
        u'exporttool.exportrun': {
            'Meta': {'ordering': "['creation_date']", 'object_name': 'ExportRun'},
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'export_arrival_times': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'export_everything_as_zip': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'export_inundation_sources': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'export_max_flowvelocity': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'export_max_waterdepth': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'export_period_of_increasing_waterlevel': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'export_possibly_flooded': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'scenarios': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['flooding_lib.Scenario']", 'symmetrical': 'False'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },
        u'exporttool.result': {
            'Meta': {'object_name': 'Result'},
            'area': ('django.db.models.fields.IntegerField', [], {}),
            'export_run': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exporttool.ExportRun']"}),
            'file_basename': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'exporttool.setting': {
