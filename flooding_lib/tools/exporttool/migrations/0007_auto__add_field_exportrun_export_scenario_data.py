...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExportRun.export_scenario_data'
        db.add_column(u'exporttool_exportrun', 'export_scenario_data', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExportRun.export_scenario_data'
        db.delete_column(u'exporttool_exportrun', 'export_scenario_data')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 13, 25, 52, 210721)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 13, 25, 52, 210271)'}),
        ...
        u'exporttool.exportrun': {
            ...
            'export_scenario_data': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
