...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('exporttool_exportrun', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('export_type', self.gf('django.db.models.fields.IntegerField')(default=10)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('run_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('approved_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('gridsize', self.gf('django.db.models.fields.PositiveIntegerField')(default=50)),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ))
        db.send_create_signal('exporttool', ['ExportRun'])

        # Adding M2M table for field scenarios on 'ExportRun'
        db.create_table('exporttool_exportrun_scenarios', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('exportrun', models.ForeignKey(orm['exporttool.exportrun'], null=False)),
            ('scenario', models.ForeignKey(orm['flooding_lib.scenario'], null=False))
        ))
        db.create_unique('exporttool_exportrun_scenarios', ['exportrun_id', 'scenario_id'])

        # Adding model 'Result'
        db.create_table('exporttool_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('file_location', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('area', self.gf('django.db.models.fields.IntegerField')()),
            ('export_run', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exporttool.ExportRun'])),
        ))
        db.send_create_signal('exporttool', ['Result'])

        # Adding model 'Setting'
        db.create_table('exporttool_setting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('exporttool', ['Setting'])


    def backwards(self, orm):
        
        # Deleting model 'ExportRun'
        db.delete_table('exporttool_exportrun')

        # Removing M2M table for field scenarios on 'ExportRun'
        db.delete_table('exporttool_exportrun_scenarios')

        # Deleting model 'Result'
        db.delete_table('exporttool_result')

        # Deleting model 'Setting'
        db.delete_table('exporttool_setting')
