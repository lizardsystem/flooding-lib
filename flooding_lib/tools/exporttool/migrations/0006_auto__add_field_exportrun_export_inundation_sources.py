...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExportRun.export_inundation_sources'
        db.add_column('exporttool_exportrun', 'export_inundation_sources', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExportRun.export_inundation_sources'
        db.delete_column('exporttool_exportrun', 'export_inundation_sources')
