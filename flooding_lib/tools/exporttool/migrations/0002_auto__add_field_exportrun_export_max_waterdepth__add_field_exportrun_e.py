...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExportRun.export_max_waterdepth'
        db.add_column('exporttool_exportrun', 'export_max_waterdepth', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ExportRun.export_max_flowvelocity'
        db.add_column('exporttool_exportrun', 'export_max_flowvelocity', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ExportRun.export_possibly_flooded'
        db.add_column('exporttool_exportrun', 'export_possibly_flooded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExportRun.export_max_waterdepth'
        db.delete_column('exporttool_exportrun', 'export_max_waterdepth')

        # Deleting field 'ExportRun.export_max_flowvelocity'
        db.delete_column('exporttool_exportrun', 'export_max_flowvelocity')

        # Deleting field 'ExportRun.export_possibly_flooded'
        db.delete_column('exporttool_exportrun', 'export_possibly_flooded')
    ...
    models = {
        ...
        'exporttool.exportrun': {
            'Meta': {'object_name': 'ExportRun'},
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'export_max_flowvelocity': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'export_max_waterdepth': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'export_possibly_flooded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'export_type': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'gridsize': ('django.db.models.fields.PositiveIntegerField', [], {'default': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'run_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'scenarios': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['flooding_lib.Scenario']", 'symmetrical': 'False'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },
        'exporttool.result': {
            'Meta': {'object_name': 'Result'},
            'area': ('django.db.models.fields.IntegerField', [], {}),
            'export_run': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exporttool.ExportRun']"}),
            'file_location': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'exporttool.setting': {
        ...
        'flooding_lib.scenario': {
            ...
            'has_hisssm_presentation': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
