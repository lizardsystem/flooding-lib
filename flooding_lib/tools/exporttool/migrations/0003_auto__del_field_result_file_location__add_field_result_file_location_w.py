...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Result.file_location'
        db.delete_column('exporttool_result', 'file_location')

        # Adding field 'Result.file_location_windows'
        db.add_column('exporttool_result', 'file_location_windows', self.gf('django.db.models.fields.TextField')(default='fill in manually'), keep_default=False)

        # Adding field 'Result.file_location_linux'
        db.add_column('exporttool_result', 'file_location_linux', self.gf('django.db.models.fields.TextField')(default='fill in manually'), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Result.file_location'
        db.add_column('exporttool_result', 'file_location', self.gf('django.db.models.fields.CharField')(default='old, fill in manually', max_length=100), keep_default=False)

        # Deleting field 'Result.file_location_windows'
        db.delete_column('exporttool_result', 'file_location_windows')

        # Deleting field 'Result.file_location_linux'
        db.delete_column('exporttool_result', 'file_location_linux')
    ...
    models = {
        ...
        'exporttool.result': {
            ...
            'file_location_linux': ('django.db.models.fields.TextField', [], {}),
            'file_location_windows': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'exporttool.setting': {
