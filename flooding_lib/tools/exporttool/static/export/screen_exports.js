...
isc.DataSource.create({
	...
	{name:"fl_rk_adm_jud", hidden: false, type:"int"},
	{name:"fl_rk_dpv_ref_part", hidden: false, type:"int"},
...
isc.ScenariosListGrid.create({
	...
	{name: "fl_rk_adm_jud", title: "kans BO trajectdeel", type: "int"},
	{name: "fl_rk_dpv_ref_part", title: "kans DPV trajectdeel", type: "int"},
