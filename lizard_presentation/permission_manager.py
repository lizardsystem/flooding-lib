...
from lizard_flooding.permission_manager import PermissionManager as PermissionManagerFlooding
from lizard_flooding.models import UserPermission as UserPermissionFlooding
