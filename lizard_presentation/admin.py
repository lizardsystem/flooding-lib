...
class DerivativeAdmin(admin.ModelAdmin):
    list_display = ('dest_presentationtype', 'source_presentationtype', 'combine_on', 'function_derivative', )

class FieldAdmin(admin.ModelAdmin):
    list_display = ('presentationtype', 'friendlyname', 'source_type', 'is_main_value_field', 'name_in_source', 'field_type', )
