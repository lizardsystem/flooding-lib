#alphabetical order 
from models import WaterlevelSet, ExternalWater
from matplotlib.ticker import Formatter
from lizard.presentation.views import get_time_step_locators, TimestepFormatter
...
class BoundaryConditions:
    ...
    def get_graph(self, destination, width, height):
        ...
        from matplotlib.ticker import MultipleLocator, MaxNLocator, FormatStrFormatter, LinearLocator  
