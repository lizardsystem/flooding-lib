...
from lizard_flooding.tools.importtool.models import ImportScenario, GroupImport
from lizard_flooding.models import Breach, Project, Scenario, SobekModel, SobekVersion
