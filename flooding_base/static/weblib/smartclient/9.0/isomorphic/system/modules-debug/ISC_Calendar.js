...
/*
  ...
  Version v9.0p_2013-08-28/LGPL Deployment (2013-08-28)
...
if (window.isc && isc.version != "v9.0p_2013-08-28/LGPL Deployment") {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v9.0p_2013-08-28/LGPL Deployment'. Mixing resources from different "
        ...
        for (var i=0; i<dataLen; i++) {
            ...
            if (overlappers && overlappers.length > 0) {
                ...
                for (var k=0; k<ranges.length; k++) {
                    if (range.lane != ranges[k].lane) continue;
                    if (this.eventsOverlap(range, ranges[k])) {
                        // this range overlaps another range
                        if (range.totalSlots < ranges[k].totalSlots) {
                            range.totalSlots = ranges[k].totalSlots;
