...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Map.layers'
        db.alter_column('base_map', 'layers', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Map.layers'
        db.alter_column('base_map', 'layers', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'flooding_base.map': {
            ...
            'layers': ('django.db.models.fields.TextField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
