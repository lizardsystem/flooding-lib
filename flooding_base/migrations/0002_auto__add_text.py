...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Text'
        db.create_table('flooding_base_text', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('language', self.gf('django.db.models.fields.CharField')(default='nl', max_length=5)),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('is_html', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('flooding_base', ['Text'])


    def backwards(self, orm):
        # Deleting model 'Text'
        db.delete_table('flooding_base_text')
